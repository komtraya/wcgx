...
"}")
    ...
    def retranslateUi(self, GradientWindow):
        ...
        self.gradient_transition_lbl.setToolTip("")
#endif // QT_CONFIG(tooltip)
        self.gradient_transition_lbl.setText(QCoreApplication.translate("GradientWindow", u"## Transition point", None))
#if QT_CONFIG(tooltip)
        self.gradient_push_slider.setToolTip(QCoreApplication.translate("GradientWindow", u"Color transition point", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.gradient_push_indicator_lbl.setToolTip("")
#endif // QT_CONFIG(tooltip)
